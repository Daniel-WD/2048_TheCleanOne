...
public class GameFieldTextureView extends TextureView implements TextureView.SurfaceTextureListener {
...
/*
    ...
    private Runnable looper = new Runnable() {
        ...
        public void run() {
            ...
            mWorkerHandler.postDelayed(looper, 15);
        }
    };


    public GameFieldTextureView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        //################################## SURFACE VIEW INIT START
...
//        animateGeneration(tile);
    ...
    private void calcMetrics() {
        ...
        mFullBlockSize = mWidth/mFieldSize;
