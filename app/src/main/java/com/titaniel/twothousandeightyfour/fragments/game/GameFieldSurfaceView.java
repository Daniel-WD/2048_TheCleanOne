...
public class GameFieldSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
...
/*
    ...
    public GameFieldSurfaceView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
